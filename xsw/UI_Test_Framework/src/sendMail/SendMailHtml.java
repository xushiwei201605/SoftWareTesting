...
//        Message msg = new MimeMessage(session, new FileInputStream(new File("C:/Users/H__D/Desktop/demo.eml")));
        ...
        fileUrl.add("F:\\QQ下载文档\\setZip\\index.html");
        fileUrl.add("F:\\QQ下载文档\\setZip\\overview.html");
        fileUrl.add("F:\\QQ下载文档\\setZip\\reportng.css");
        fileUrl.add("F:\\QQ下载文档\\setZip\\reportng.js");
        fileUrl.add("F:\\QQ下载文档\\setZip\\sorttable.js");
        fileUrl.add("F:\\QQ下载文档\\setZip\\suite1_test1_results.html");
        fileUrl.add("F:\\QQ下载文档\\setZip\\suites.html");
